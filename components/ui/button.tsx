...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-md active:hover:scale-[98%] text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
